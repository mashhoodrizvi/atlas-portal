...
function parseDurationMinutes(value) {
  ...
  if (Number.isFinite(numeric)) {
    // Google Sheets duration can sometimes arrive as a decimal day.
    return numeric < 1 ? Math.round(numeric * 24 * 60) : Math.round(numeric * 60);
  }
        ...
        <tr>
          ...
          <td>
            <input
              ...
              min="0"
              step="0.01"
              value="${escapeHTML(record["Paid Amount"])}"
